...
public class StateLayout extends FrameLayout {
    ...
    private void initLayout() {
        ...
        mMainLayout = (ViewGroup) LayoutInflater.from(getContext()).inflate(R.layout.view_state_layout, this, false);
    ...
    private final OnClickListener mClickWrapper = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            mListener.onRetry(StateLayout.this);
        }
    };
    ...
    public interface OnRetryListener {
         ...
         * 点击了重试
         */
        void onRetry(StateLayout layout);
    }
}
